...
def main(argv):
    ...
    try:
        ...
        print('mcdsatplus_endec.py -a <action> -i <inputfile> -m <mappings> -o <outputfile>')
        sys.exit(2)
   
    for opt, arg in opts:
        if opt == '-h':
            print('mcdsatplus_endec.py -a <generate|encode|decode> -i <inputfile> -m <mappings> -o <outputfile>')
            sys.exit()
